...
def main():
    ...
    generate_parser.add_argument(
        "--path", required=True, dest="directory", help="The root directory to scan."
    )
    generate_parser.add_argument(
    ...
    generate_parser.add_argument(
        ...
        help="The path to the private key for signing.",
    )
    generate_parser.add_argument(
        "--model-name", required=True, help="The name of the model or project."
    )
    generate_parser.add_argument(
        "--model-version", required=True, help="The version of the model or project."
    )
    generate_parser.add_argument(
    ...
    verify_parser.add_argument(
        "--manifest-file", required=True, help="The manifest file to verify."
    )
    verify_parser.add_argument(
        "--directory",
        default=".",
        help="The root directory of the project files to verify against.",
    )
    ...
    group.add_argument(
        "--trusted-key", help="The name of the trusted key to use for verification."
    )
    ...
    if args.command == "keys":
        ...
        verify_manifest.verify_manifest(
            args.manifest_file, args.directory, args.public_key, args.trusted_key
        )
